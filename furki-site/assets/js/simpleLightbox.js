    ...
    $.extend(SimpleLightbox.prototype, {
        ...
        prepareItem: function(position, callback) {
            ...
            if (this.options.videoRegex.test(url)) {
                ...
                callback.call(self, $('<div class="slbIframeCont"><video class="slbIframe" controls  loop muted src="' + url + '"></video></div>'));
            ...
            if (!this.$el) {
                ...
                this.$el = $(
                    '<div class="slbElement ' + o.elementClass + '">' +
                        ...
                        '<div style="padding: 12px; position: absolute; z-index:999" class="row">' +
